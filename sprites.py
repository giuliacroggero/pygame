import random
import pygame
from config import WIDTH, HEIGHT, CANETA_WIDTH, CANETA_HEIGHT, CONTROLE_WIDTH, CONTROLE_HEIGHT, LATINHA_WIDTH, LATINHA_HEIGHT, MACA_WIDTH, CENOURA_WIDTH, RACAO_WIDTH, BISCOITO_WIDTH
